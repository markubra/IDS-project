...
-- Ktere familie nevlastni zadny rajon? (EXIST)
-- SELECT "nazev", "typ podnikani" FROM "FAMILIE" WHERE NOT EXISTS (SELECT * FROM "RAJON" WHERE "FAMILIE"."nazev" = "familie" AND "familie" IS NOT NULL);
